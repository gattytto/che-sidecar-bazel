...
RUN mkdir -p /projects/googleapis && git clone https://github.com/googleapis/googleapis.git /projects && cd /projects/googleapis && bazel fetch ...: && bazel run -- //:build_gen --src=google && bazel fetch ...:
