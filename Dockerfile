...
RUN mkdir /projects && mkdir -p /home/theia && \
    ...
    dnf install -y python38 https://download-ib01.fedoraproject.org/pub/fedora/linux/releases/31/Everything/aarch64/os/Packages/b/binutils-gold-2.32-24.fc31.aarch64.rpm
